...
function colorModeToggle() {
  ...
  function setImageForMode(isDark, darkId, lightId, changeClass) {
    const logoImage = document.querySelectorAll(changeClass); // Ensure this is the correct ID of your logo
    if (logoImage) {
  ...
  function goDark(dark, animate) {
    setImageForMode(dark, "logo-dark", "logo-light", ".logo");
    if (dark) {
